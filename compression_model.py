...
#pvals = {'p_sigt': 2000e-15, 'p_sige': 1e-5}
...
#result = minimize(UKXFEL_tracker.opt_func, UKXFEL_tracker.initial_guess(), args = (obj_func, pvals), method = 'Nelder-Mead', bounds = UKXFEL_bounds, options = {'maxiter':2e4, 'fatol':0.01})
